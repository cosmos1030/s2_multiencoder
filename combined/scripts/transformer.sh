...
if [ "$MODE" = "train" ]; then
  ...
  if [ "$DATASET" = "cifar100" ]; then
    ...
    python main.py \
      ...
      --clip_num_prefix 1 \
      --dino_num_prefix 1 \
      --checkpoint_dir "./checkpoints/cifar100/both_s2_transformer" \
      --resume_checkpoint "./checkpoints/cifar100/both_s2_transformer/best_epoch_3.pth" \
      --project_name "s2multiencoder_transformer"
